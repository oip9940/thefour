...
<script type="text/javascript">
	$(document).ready(function(){
		$("#btn-write").click(() => {
			location.href="<c:url value='adnoticeregister.do?viewPage=${bp.viewPage}'/>";
		})
		...
		$(".goView").on("click", function(e){
			...
			moveForm.append("<input type='hidden' name='brd_num' value='"+
					$(this).attr("href")+"'>");
			moveForm.attr("action", "adnoticeview.do");
			moveForm.submit();
		});
...
<form id="searchForm" method="post" action="adnoticelist.do">
