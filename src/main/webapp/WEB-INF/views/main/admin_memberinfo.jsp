	        ...
	        <div class="row">
	          <div class="center card-title">
	                ...
	                <div class="funds-card-colored">
	                    <h3 style="color:#d1d5db;">회원 정보</h3>
	                    ...
	                    <div class="hidden-xs member-table">
                    ...
                    <input type="submit" value="수정하기" class="btn btn-modify"/>
                    <a type="button" class="btn btn-back" href="admemberlist.do">리스트</a>
                    <!-- end of colored card -->
                </div>
		<!-- end of row -->
	</div>
